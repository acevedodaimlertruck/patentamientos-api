...
{
    public class BaseUniversalRepository<T> : IBaseUniversalRepository<T> where T : BaseUniversalEntity, new()
    {
        public readonly UniversalDbContext Context;
        private bool _disposed = false;

        public BaseUniversalRepository(UniversalDbContext context)
        {
            Context = context;
        }
