...
namespace LCH.MercedesBenz.Api.Migrations
{
    ...
    [Migration("20240223155825_AltBodystDefaultValue")]
    partial class AltBodystDefaultValue
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LCH.MercedesBenz.Api.Models.Application.RegSecs.RegSec", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000033"),
                            AutoId = 0,
                            DepartmentId = new Guid("00000000-0000-0000-0000-000000000033"),
                            Description = "NOASIGNADO",
                            IsDeleted = false,
                            LocationId = new Guid("00000000-0000-0000-0000-000000000033"),
                            Name = "NOASIGNADO",
                            ProvinceId = new Guid("00000000-0000-0000-0000-000000000033")
                        });
                });
            ...
            modelBuilder.Entity("LCH.MercedesBenz.Api.Models.Application.InternalVersionSegmentations.InternalVersionSegmentation", b =>
                {
                    ...
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.CatRules.CatRule", null)
                        .WithMany("InternalVersionSegmentations")
