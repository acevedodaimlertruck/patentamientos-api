...
namespace LCH.MercedesBenz.Api.Migrations
{
    ...
    [Migration("20240222155647_New_CabinCF_CabinSD_CompetitiveCJD_Configuration_AltBodyst_AltCateg_AltSegm_AMGCompSet_PBTTN_NI_RelevMB_SegmentationAux1_SSegm_Group")]
    partial class New_CabinCF_CabinSD_CompetitiveCJD_Configuration_AltBodyst_AltCateg_AltSegm_AMGCompSet_PBTTN_NI_RelevMB_SegmentationAux1_SSegm_Group
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LCH.MercedesBenz.Api.Models.Application.InternalVersionSegmentations.InternalVersionSegmentation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Description = "NOASIGNADO",
                            InternalVersionId = new Guid("00000000-0000-0000-0000-000000000033"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("LCH.MercedesBenz.Api.Models.Application.InternalVersionSegmentations.InternalVersionSegmentation", b =>
                {
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.AMGCompSets.AMGCompSet", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("AMGCompSetId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.AltBodysts.AltBodyst", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("AltBodystId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.AltCategs.AltCateg", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("AltCategId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.AltSegms.AltSegm", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("AltSegmId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.ApertureFours.ApertureFour", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("ApertureFourId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.ApertureThrees.ApertureThree", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("ApertureThreeId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.AxleBases.AxleBase", null)
                        .WithMany("InternalVersionSegmentations")
                    ...
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.CJDCompetitives.CJDCompetitive", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("CJDCompetitiveId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.CabinCFs.CabinCF", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("CabinCFId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.CabinSDs.CabinSD", null)
                        .WithMany("InternalVersionSegmentations")
                    ...
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.CompetitiveCJDs.CompetitiveCJD", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("CompetitiveCJDId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.Configurations.Configuration", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("ConfigurationId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.Doors.Door", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("DoorId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.EngineCapacitys.EngineCapacity", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("EngineCapacityId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.FuelTypes.FuelType", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("FuelTypeId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.Gears.Gear", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("GearId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.Groups.Group", null)
                        .WithMany("InternalVersionSegmentations")
                    ...
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.MCGTotalMkts.MCGTotalMkt", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("MCGTotalMktId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.MotorDTs.MotorDT", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("MotorDTId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.NIs.NI", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("NIId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.PBTs.PBT", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("PBTId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.PBTTNs.PBTTN", null)
                        .WithMany("InternalVersionSegmentations")
                    ...
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.RelevMBs.RelevMB", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("RelevMBId");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.SSegms.SSegm", null)
                        .WithMany("InternalVersionSegmentations")
                    ...
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.SegmentationAux1s.SegmentationAux1", null)
                        .WithMany("InternalVersionSegmentations")
                        .HasForeignKey("SegmentationAux1Id");

                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.Sources.Source", null)
                        .WithMany("InternalVersionSegmentations")
                    ...
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.WheelBases.WheelBase", null)
                        .WithMany("InternalVersionSegmentations")
