...
namespace LCH.MercedesBenz.Api.Migrations
{
    ...
    [Migration("20231002135543_DeleteProvinceIdInFactory")]
    partial class DeleteProvinceIdInFactory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LCH.MercedesBenz.Api.Models.Application.TMMVS.TMMV", b =>
                {
                    ...
                    b.Property<string>("ZMarca")
                        .HasMaxLength(512)
                        .IsUnicode(false)
                        .HasColumnType("varchar(512)");

                    b.Property<string>("ZModelo")
                        .HasMaxLength(512)
                        .IsUnicode(false)
                        .HasColumnType("varchar(512)");

                    b.Property<string>("ZTerminal")
                        .HasMaxLength(512)
                        .IsUnicode(false)
                        .HasColumnType("varchar(512)");
            ...
            modelBuilder.Entity("LCH.MercedesBenz.Api.Models.Application.Factories.Factory", b =>
                {
                    b.HasOne("LCH.MercedesBenz.Api.Models.Application.Provinces.Province", null)
                        .WithMany("Factories")
